...
namespace Michsky.MUIP
{
    ...
    public class ContextMenuContentEditor : Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            var menuSpawnPos = serializedObject.FindProperty("menuSpawnPos");
            var contexItems = serializedObject.FindProperty("contexItems");
            var useIn3D = serializedObject.FindProperty("useIn3D");
            var fixedMenu = serializedObject.FindProperty("fixedMenu");
            ...
            switch (currentTab)
            {
                ...
                case 1:
                    ...
                    MUIPEditorHandler.DrawProperty(menuSpawnPos, customSkin, "Menu Spawn Position");
                    break;

                case 2:
                    MUIPEditorHandler.DrawHeader(customSkin, "Options Header", 6);
                    useIn3D.boolValue = MUIPEditorHandler.DrawToggle(useIn3D.boolValue, customSkin, "Use In 3D");
                    fixedMenu.boolValue = MUIPEditorHandler.DrawToggle(fixedMenu.boolValue, customSkin, "Fixed Menu");
                    break;
            }
