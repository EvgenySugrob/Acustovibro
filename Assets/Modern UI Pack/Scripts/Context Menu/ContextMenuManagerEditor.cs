...
namespace Michsky.MUIP
{
    ...
    public class ContextMenuManagerEditor : Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            var shadow = serializedObject.FindProperty("shadow");
            ...
            switch (currentTab)
            {
                ...
                case 1:
                    ...
                    MUIPEditorHandler.DrawProperty(trigger, customSkin, "Trigger Zone");
                    MUIPEditorHandler.DrawProperty(shadow, customSkin, "Border Shadow");
