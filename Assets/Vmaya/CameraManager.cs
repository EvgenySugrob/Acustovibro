...
namespace Vmaya
{
    public class CameraManager : MonoBehaviour
    {
        ...
        [SerializeField]
        private bool useNextCameraAxis;
        ...
        public bool mode2d
        {
            get
            {
                return getCurrent().orthographic;
            }
        }
        ...
        public bool gameMode
        {
            get
            {
                return currentCameraIndex == playerCamera;
            }
        }
        ...
        void Update()
        {
            ...
            if (useNextCameraAxis)
            {
                int incnc = Input.GetAxisRaw("NextCamera") > 0 ? 1 : (Input.GetAxisRaw("NextCamera") < 0 ? -1 : 0);
