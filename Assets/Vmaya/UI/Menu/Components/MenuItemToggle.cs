...
namespace Vmaya.UI.Menu
{
    public class MenuItemToggle : MenuItem
    {
        ...
        private bool isToggle => data != null ? actionToggleList.Contains(data.action) : false;
        private float toggleWidth => isToggle ? _toggle.GetComponent<RectTransform>().rect.width : 0;

        public static List<string> actionToggleList = new List<string>() { "modeDimension", "stateFlashlight" };
