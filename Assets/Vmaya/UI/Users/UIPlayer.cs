...
namespace Vmaya.UI.Users
{
    public class UIPlayer : MonoBehaviour, IRW, IOpener
    {
        ...
        public static UIPlayer instance { get => _instance; }
        ...
        protected virtual void Awake()
        {
            ...
            if (_fileNameField) GeneralData.onChangeFilename.AddListener(onChangeFilename);
        }
        ...
        private bool isDevUser
        {
            get
            {
                return Application.isEditor && devUser;
            }
        }
        ...
        public virtual void checkAndSaveSettings()
        {
        ...
        public void Exit()
        {
            if (GeneralData) GeneralData.Save();
            checkAndSaveSettings();
            Application.Quit();
        }
