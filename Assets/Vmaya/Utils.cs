...
namespace Vmaya
{
    public class Utils
    {
        ...
        */
        ...
        public static bool findFutureCollisions(Collider myCol, ref Vector3 a_delta, Transform root = null, Quaternion newRotation = default)
        {
            ...
            if (myCol != null)
            {
                ...
                {
                    if (!col.transform.IsChildOf(myCol.transform))
                    {
                        Vector3 direct;
                        float distance;
